        ...
        <Section title="Introduction">
          <div className="papyrus">
            <div className="papyrus-section">
              ...
              <p>
                Once you've acquired all five Soulstones from the various storyline quests throughout the game, you'll
                be able to perform the rebirth process. Though there are minimum requirements for each rebirth, and it
                is advised max out your character's requirements to maximize your character's potential post-rebirth
                such as resistances and growth rate.
              </p>
              <ul>
