...
function PageGuidesLeveling() {
  return (
    <>
      <Header heading="Leveling" />
      <div className="content-wrapper">
        <Section heading="Level 1-6" className="panel">
          <h3>Tutorial</h3>
          <ol>
        ...
        <Section heading="Level 6-21" className="panel">
        ...
        <Section heading="Level 6-21-30" className="panel">
          <h3>Stonesmith</h3>
          <p>
            You can begin the Stonesmith quest from level 6 onwards by visiting Stonesmith in Woodlingor (162, 342). He
            will task you with collecting a certain amount of items by fighting in different zones depending on your
            level. Those areas are Revive Arena, Snow Ridge, Sunset Plains, Southern Rivage, Badlands and Bone Desert.
            The first three are connected between the two cities of Woodlingor and Blython, the last three are connected
            between Blython and Desert City which can be accessed through the Woodlingor Teleporter (87, 136).
          </p>
          <ol>
        ...
        <Section heading="Level 30-50" className="panel">
          <h3>Howling Beast</h3>
          <p>
            ...
            each fight rewarding you with increasing XP. Upon killing the last monster, you will have completed one
            round - up to ten rounds total. Each round will see you fighting the same monsters, except with better XP
            rewards.{" "}
            <b>
          ...
          <p>
            If you&apos;re unable to find a party, a good alternative depending on your level is Tumulus 2-5, which can
            be entered both from the Blython Teleporter or by walking through Bone Desert from Desert City. There are
            also two leveling alternatives you can use from level 30 onwards, both of which are covered in the next
            section.
          </p>
        </Section>
        <Section heading="Level 30+" className="panel">
          <h3>Drow & Wednesday Event</h3>
          <h4>Drowcrusher</h4>
          <p>
            Drowcrusher is a monster that can be fought with a party from level 30 onwards. It rewards 100k XP per kill.
            The limit used to be set to five per day, however it is currently unlimited. In order to fight Drowcrusher
            (also referred to as &quot;Drow&quot;), you will need to give him a Tier 5 equipment corresponding to your
            race and gender. Below is a table that shows exactly which character-specific piece of equipment you need to
            give him - those can be obtained either through forging, buying from other players or using a Convenience
            Store item, the latter being the most efficient. You can ask for help in World Chat by saying &quot;Drow
            Lead looking for 1hit party&quot; and inviting the respondents to your party.
          </p>
          ...
          <p>
            <em>
              ...
              ~100k XP to both you and your pet with a chance of obtaining Dispel Potions, Talent Points, Pet Intimacy,
              Perfect Carnelians and High-Graded Gems.
            </em>
          </p>
          <p>
        ...
        <Section heading="Level 50-60" className="panel">
        ...
        <Section heading="Level 60-70" className="panel">
          <h3>Blython Defense</h3>
          <p>
            At level 60, you can move from Woodlingor to Blython Defense. It's virtually identical except with increased
            XP rewards.
          </p>
          <ol>
        ...
        <Section heading="Level 60-80" className="panel">
          <h3>Bloodreaper</h3>
          <p>
        ...
        <Section heading="Level 70-90" className="panel">
          <h3>Seal</h3>
          <p>
          ...
          <details>
            ...
            <table id="seal-table" className="blue-table table-rowspan">
              <thead>
                <tr>
                  <th>Zone</th>
                  <th>Coords</th>
        ...
        <Section heading="Level 90+" className="panel">
          ...
          <h4>Papa Drow</h4>
          <p>
            Drow Lord, more commonly referred to as &quot;Papa Drow&quot;, functions pretty much identically to regular
            Drowcrusher. The only real difference being a drastic increase in difficulty. Similarly to Drowcrusher, Papa
            Drow can be repeated as much as you like without limits. Note that your experience gains will be drastically
            reduced after reaching level 110.{" "}
            <b>
              Contrary to regular Drowcrusher, all characters require the same type of equipment to fight Papa Drow (+5
              weapon of their own race & gender)
            </b>
            .
          </p>
          <ol>
          ...
          <p>
            ...
            round, currently unsure if there's a cap/reset. It's more difficult than most leveling methods up until this
            point, so it's generally a good idea to refer to guides like these:
          </p>
          <ul>
            <li>
              <a
