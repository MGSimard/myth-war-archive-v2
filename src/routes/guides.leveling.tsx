          ...
          <div className="papyrus">
            <div className="papyrus-section">
              ...
              <p>
                ...
                Desert. The first three are connected between the two cities of Woodlingor and Blython, the last three
                are connected between Blython and Desert City which can be accessed through the Woodlingor Teleporter
                (87, 136).
              </p>
              <ol>
                ...
                <li>
                  Once you have done so, return to Stonesmith in Woodlingor (162, 343) and turn the items in for
                  100-150% of your level in experience
                </li>
          ...
          <div className="papyrus">
            <div className="papyrus-section">
              ...
              <p>
                ...
                different zones, each fight rewarding you with increasing XP. Upon killing the last monster, you will
                have completed one round - up to ten rounds total. Each round will see you fighting the same monsters,
                except with better XP rewards.{" "}
                <b>
              ...
              <ol>
                ...
                <ol>
                  ...
                  <li>
                    Continue killing these three then reset the quest; their XP rewards will be locked to round
                    10&apos;s XP accumulation, successfully avoiding an XP reset
                  </li>
                </ol>
              </ol>
              <p>
                If you&apos;re unable to find a party, a good alternative depending on your level is Tumulus 2-5, which
                can be entered both from the Blython Teleporter or by walking through Bone Desert from Desert City.
                There are also two leveling alternatives you can use from level 30 onwards, both of which are covered in
                the next section.
              </p>
            </div>
          </div>
          ...
          <div className="papyrus">
            ...
            <div className="papyrus-section">
              ...
              <p>
                ...
                corresponding to your race and gender. Below is a table that shows exactly which character-specific
                piece of equipment you need to give him - those can be obtained either through forging, buying from
                other players or using a Convenience Store item, the latter being the most efficient. You can ask for
                help in World Chat by saying &quot;Drow Lead looking for 1hit party&quot; and inviting the respondents
                to your party.
              </p>
            ...
            <div className="papyrus-section">
              ...
              <p>
                For the entire duration of Wednesday (server time), you can participate in a repeatable 100 round quest
                by going to Woodlingor and talking to Charity Ambassador in Elder Zone. You will be asked to visit a
                certain NPC to either answer a question, bring them an item or pass a message. Each NPC will give you a
                reward and another task to complete all the way up to 100 tasks.
              </p>
              <p>
                The general trick is to fill blank teleport scrolls and a few colored scrolls, leaving 1-2 free spaces
                for rewards and registering one scroll for each of the NPC locations at the bottom of your inventory.
                After using a scroll, you can drag an empty scroll into that slot and re-register the location for
                later.
              </p>
        ...
        <Section title="Level 60-70">
          <div className="papyrus">
            <div className="papyrus-section">
              ...
              <p>
                <b>
                  Note: when Defender says "Armory", the actual location is Weaponry. 2x Armory means both NPCs inside
                  are possible targets. Additionally, "Accessories Shop" means Stuff Shop.
                </b>
              </p>
            </div>
          </div>
          ...
          <div className="papyrus">
            ...
            <div className="papyrus-section">
              ...
              <p>
                ...
                Drowcrusher, Papa Drow can be repeated as much as you like without limits. Note that your experience
                gains will be drastically reduced after reaching level 110.{" "}
                <b>
            ...
            <div className="papyrus-section">
              ...
              <p>
                Like a lot of other quests, Worn Messenger is a repeatable round-based quest. Experience gains after
                every round, currently unsure if there's a cap/reset. It's more difficult than most leveling methods up
                until this point, so it's generally a good idea to refer to guides like these:
              </p>
              <ul>
                <li>
                  <a
