      ...
      <div className="content-wrapper">
        <Section heading="Introduction" className="panel">
          ...
          <p>
            ...
            game's rich fantasy setting through four character races; Humans, Centaurs, Mages, and Borgs. The game also
            featured a robust pet system allowing pets to fight alongside their masters.
          </p>
          <hr />
          ...
          <p>
            ...
            as one of the "Top Ten Chinese IT Leaders of the Year" in 2004. Following the malicious bankruptcy of
            Xinruishi in 2003, Zhuang and many of his team members joined Unigium, bringing with them years of
            expertise.
          </p>
          <p>
            The collaborative effort between Unigium and its Singapore counterpart, Sing-Gium International, under the
            umbrella of Gium International, allowed the team to launch Myth War Online successfully. The game's distinct
            musical score, produced by Li Dongjun(李东军) and performed by the Singapore National Symphony Orchestra,
            further highlighted their dedication to quality. The development of Myth War Online was supported with some
            outsourcing with developers and artists from Japan and the United States.
          </p>
          <hr />
        ...
        <Section heading="Timeline" id="timeline-section">
