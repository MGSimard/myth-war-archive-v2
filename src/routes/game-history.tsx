        ...
        <Section title="Introduction">
          <div className="papyrus">
            <div className="papyrus-section">
              ...
              <p>
                Myth War Online, developed by Unigium and published by Sing-Gium International, then IGG in the west—was
                a free-to-play 2.5D MMORPG that brought players into a vibrant, mythological world filled with unique
                ...
                the game's rich fantasy setting through four character races; Humans, Centaurs, Mages, and Borgs. The
                game also featured a robust pet system allowing pets to fight alongside their masters.
              </p>
            </div>
            <hr />
            <div className="papyrus-section">
              ...
              <ul className="ul">
                <li>
                  The Rumor System, where players could interact with NPCs to spread tales about their characters.
                </li>
            ...
            <div className="papyrus-section">
              ...
              <p>
                The collaborative effort between Unigium and its Singapore counterpart, Sing-Gium International, under
                the umbrella of Gium International, allowed the team to launch Myth War Online successfully. The game's
            ...
            <div className="papyrus-section">
              ...
              <p>
                ...
                refined and streamlined gameplay with features like updated character designs, enhanced graphics, new
                boss mechanics, and systems like Second Rebirth, Relationships & Marriage, Power Worship, Holy Sets,
                Mine War Events and more. Despite these improvements, Myth War II struggled to retain its predecessor's
                magic and ultimately shut down in 2015.
              </p>
            </div>
            <hr />
            <div className="papyrus-section">
              ...
              <p>
                Though the official servers for both games have long been offline, the Myth War community persists.
                Today, the only fully operational private server, TDT, runs Myth War II, keeping the spirit of the game
                alive. The only other known server, the once-promising Chinese sj.51wgg.com, has remained dormant since
                their planned reopenings in 2019 and 2021 failed to materialize.
              </p>
            </div>
            <hr />
            <div className="papyrus-section">
          ...
          <Timeline
            items={[
              ...
              },
              {
                ...
                description: (
                  <>
                    Zhuang Jinlong(庄锦隆) joins Unigium(联竣信息科技（上海）有限公司) and becomes the Director &
                    General Manager of the "God World/Myth War"(神界) project. A large portion of the employees,
                    development tooling and assets come directly from Xinruishi.{" "}
                    <a
