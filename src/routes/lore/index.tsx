        ...
        <div className="papyrus">
          <div className="papyrus-section">
            ...
            <p>
              ...
              noted for their superior combat skills. Apart from the offensive side of Paladin nature, they are also
              good at defense. One can term them as moving castles during battles. However one drawback of this class is
              that the equipment they carry is relatively heavy because of all the heavy-based weapons and armor they
              carry and therefore their agility is compromised. A high-level Paladin is able to advance to a
              magic-swordsman.
            </p>
            <h4>Thief</h4>
            <p>
              Thieves are known to have a wicked and nasty nature. Their outward appearance takes on the usual shape of
              a slim body and they dress in a corset and mask mainly. Their preferred weapons are daggers and knives.
              ...
              well. Thieves can be powerful allies to team up with. A high-level Thief can advance to become an
              Assassin.
            </p>
          </div>
          <hr />
          <div className="papyrus-section">
            ...
            <p>
              ...
              light armor or silk clothing to ensure their agility is not hindered; One disadvantage of this is that
              their armor shielding is low and they have low hit points as well. A high-level Archer can be upgraded to
              become a Hunter.
            </p>
            <h4>Elf</h4>
            <p>
              ...
              attack fast as well as have high chances to evade attacks. Elves have great advantages when facing enemies
              like the undead because they are able to bless teammates with the force of nature. Elves, however, are
              very delicate and there is a strong need to protect them in battle. High-level Elves can be upgraded to
              become Knight-Elves.
            </p>
          </div>
          <hr />
          <div className="papyrus-section">
            ...
            <p>
              ...
              was cursed again after they sold their souls to the dark lord. Their skin is a weird tinge of blue due to
              a curse by the Gods. This prevents them from ever seeing or being in sunlight. The lands they inhabit are
              filled with nothing but darkness. This unfairness they felt led to great hatred and a strong desire to
              take revenge. However, they were wise enough to forgive the world and progress in a more positive
            ...
            <p>
              ...
              and fire. Their brand of magic is dark in opposition to the holy one. As they are deprived of sunlight,
              they are weak in close combat. They compensate for this weakness by having spells which can have
              unbelievable powers, having great advantages over their enemies during melee attacks. However, their
              weakest links are their low armor and low hit points. A priest is able to advance to High Priest.
            </p>
            <h4>Witch</h4>
            <p>
          ...
          <div className="papyrus-section">
            ...
            <p>
              ...
              embodiment of the mages' advanced intelligence was put in the robot's body to make them move again. Parts
              of this robot would release rays of light as the Silver Driver was operating. Moreover, inspired by
              technology the mages invented a flight propulsion system for the robots which enabled them to fly without
              using magic.
            </p>
            <h4>Tyrant</h4>
            <p>
              Tyrants emerge from the ruins so they are more adept at battle, having a super-powerful body. They are
              great experts in battle and have only one focus on their mind, to attack. Although they can only use slow
              and heavy weapons the damage inflicted is massive. They are good at absorbing hit points as well as
              rebounding attacks.
            </p>
            <h4>Cyborg</h4>
            <p>
              ...
              due to their healing contribution. They are also good at solo fights. Their primary weapons are spears. As
              a spear is a two-handed weapon, they cannot use shields. They have slower attack rates, weak defense, but
